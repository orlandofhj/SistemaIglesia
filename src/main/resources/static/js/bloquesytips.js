...
function renderAllBlocks(lista = blocksData) {
    ...
    // ⚡ Construcción del contenedor de paginación ⚡
    ...
    if (totalPages > 1) {
        ...
        prevBtn.onclick = () => { if(currentPageGrid > 1) { currentPageGrid--; renderAllBlocks(lista); } };
        ...
        for (let i = 1; i <= totalPages; i++) {
            ...
            pageBtn.onclick = () => { currentPageGrid = i; renderAllBlocks(lista); };
        ...
        nextBtn.onclick = () => { if(currentPageGrid < totalPages) { currentPageGrid++; renderAllBlocks(lista); } };
