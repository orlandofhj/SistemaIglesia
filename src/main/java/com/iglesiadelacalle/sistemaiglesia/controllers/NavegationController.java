...
public class NavegationController {
    ...
    // 13. Ruta para la página de Registro
    @GetMapping("/registro")
    public String mostrarRegistro() {
        return "Registro"; 
    }

    // 14 ⚡ MAPEADO DE LA VISTA (Para que cargue el HTML)
    @GetMapping("/mis-ministerios")
    public String misMinisterios() {
        return "MisMinisterios"; 
    }

    // 15 ⚡ MAPEADO DE LA VISTA (Para que cargue el HTML)
    @GetMapping("/clases-teologia")
    public String clasesTeologia() {
        return "ClasesTeologia"; 
    }

    // 16 ⚡ MAPEADO PARA "MIS BLOQUES"
    @GetMapping("/mis-bloques")
    public String misBloques() {
        return "MisBloques"; 
    }

    // 17 ⚡ NUEVA RUTA PARA "MIS TEOLOGÍAS"
    @GetMapping("/mis-teologias")
    public String misTeologias() {
        return "MisTeologias"; 
    }
